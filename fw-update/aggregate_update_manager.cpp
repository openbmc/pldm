    ...
    const std::string& updateObjPath)
{
    ...
    descriptorMap[softwareIdentifier] = &descriptors;
    componentInfoMap[softwareIdentifier] = &componentInfo;

    updateManagers[softwareIdentifier] = std::make_shared<ItemUpdateManager>(
