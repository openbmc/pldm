...
int ItemUpdateManager::processPackage()
{
...
std::string ItemUpdateManager::processFd(int fd)
{
    ...
    deferHandler = std::make_unique<sdeventplus::source::Defer>(
        event, [this, dupFd](sdeventplus::source::EventBase&) {
...
void ItemUpdateManager::updateDeviceCompletion(mctp_eid_t /*eid*/,
                                               bool /*status*/)
{
...
void ItemUpdateManager::clearActivationInfo()
{
    activation->activation(software::Activation::Activations::Active);
