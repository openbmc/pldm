...
class AggregateUpdateManager final :
    public std::map<DeviceIdentifier,
                    std::tuple<std::unique_ptr<DescriptorMap>,
                               std::unique_ptr<ComponentInfoMap>,
    ...
    public UpdateManager
{
  public:
    ...
    std::pair<AggregateUpdateManager::iterator, bool>
        insert_or_assign(const DeviceIdentifier& deviceIdentifier,
