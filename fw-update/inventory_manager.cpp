...
void InventoryManager::sendQueryDeviceIdentifiersRequest(mctp_eid_t eid)
{
    ...
    {
        error("Failed to allocate instance id in sendQueryDeviceIdentifiersRequest: {ERROR}", "ERROR",
                   e.what());
        throw;
    }
    Request requestMsg(
...
void InventoryManager::sendQueryDownstreamDevicesRequest(mctp_eid_t eid)
{
    ...
    {
        error("Failed to allocate instance id in sendQueryDownstreamDevicesRequest: {ERROR}", "ERROR",
                   e.what());
        throw;
    }
    auto request = new (requestMsg.data()) pldm_msg;
    ...
    enum transfer_op_flag transferOperationFlag)
{
    ...
    {
        error("Failed to allocate instance id in sendQueryDownstreamIdentifiersRequest: {ERROR}", "ERROR",
                   e.what());
        throw;
    }
    Request requestMsg(
    ...
    enum transfer_op_flag transferOperationFlag)
{
    ...
    {
        error("Failed to allocate instance id in sendGetDownstreamFirmwareParametersRequest: {ERROR}", "ERROR",
                   e.what());
        throw;
    }
    auto request = new (requestMsg.data()) pldm_msg;
...
void InventoryManager::sendGetFirmwareParametersRequest(mctp_eid_t eid)
{
    ...
    {
        error("Failed to allocate instance id in sendGetFirmwareParametersRequest: {ERROR}", "ERROR",
                   e.what());
        return;
    }
    Request requestMsg(
