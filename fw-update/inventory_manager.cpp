                                               ...
                                               uint64_t& supportedTypes)
{
    ...
    {
        error(
            "Failed to encode get PLDM Types request for endpoint ID {EID}, response code {RC}.",
            "EID", eid, "RC", rc);
        co_return rc;
    }
    ...
    {
        error(
            "Failed to decode get PLDM Types response for endpoint ID {EID}, response code {RC}.",
            "EID", eid, "RC", rc);
        co_return rc;
    }
