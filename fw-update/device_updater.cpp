                                      ...
                                      size_t payloadLength)
{
    ...
    error("offset = {OFFSET}, length = {LEN}", "OFFSET", offset,
          "LEN", length);
                                         ...
                                         size_t payloadLength)
{
    ...
    else
    {
        error(
            ...
            "EID", eid, "COMP_VERS", compVersion, "TRANS_RES",
            transferResult);
    }
                                       ...
                                       size_t payloadLength)
{
    ...
    else
    {
        error(
            ...
            "EID", eid, "COMP_VERS", compVersion, "VERIFY_RES",
            verifyResult);
    }
                                      ...
                                      size_t payloadLength)
{
    ...
    else
    {
        error(
            ...
            "EID", eid, "COMP_VERS", compVersion, "APPLY_RES",
            applyResult);
    }
