...
void DeviceUpdater::startFwUpdateFlow()
{
    ...
    if (rc)
    {
        // Handle error scenario
        error(
            "Send RequestUpdate request for endpoint ID '{EID}' failed with response code '{RC}'",
            "EID", unsigned(eid), "RC", rc);
    }
}
                                  ...
                                  size_t respMsgLen)
{
    ...
    {
        // Handle error scenario
        error("No response received for RequestUpdate for endpoint ID '{EID}'",
              "EID", unsigned(eid));
        return;
    }
    ...
    {
        error(
            "Decoding RequestUpdate response for endpoint ID '{EID}' failed with response code '{RC}'",
            "EID", unsigned(eid), "RC", rc);
        return;
    }
    if (completionCode)
    {
        error(
            "RequestUpdate response for endpoint ID '{EID}' failed with completion code '{CC}'",
...
void DeviceUpdater::sendPassCompTableRequest(size_t offset)
{
    ...
    if (rc)
    {
        // Handle error scenario
        error(
            "Send PassComponentTable request for endpoint ID '{EID}' failed with response code '{RC}'",
            "EID", unsigned(eid), "RC", rc);
    }
}
                                  ...
                                  size_t respMsgLen)
{
    if (response == nullptr || !respMsgLen)
    {
        // Handle error scenario
        error(
            "No response received for PassComponentTable for endpoint ID '{EID}'",
            "EID", unsigned(eid));
        return;
    }
    ...
    if (rc)
    {
        // Handle error scenario
        error(
            "Decoding PassComponentTable response for endpoint ID '{EID}' failed with response code '{RC}'",
            "EID", unsigned(eid), "RC", rc);
        return;
    }
    if (completionCode)
    {
        // Handle error scenario
        error(
            "PassComponentTable response for endpoint ID '{EID}' failed with completion code '{CC}'",
            "EID", unsigned(eid), "CC", unsigned(completionCode));
        return;
    }
...
void DeviceUpdater::sendUpdateComponentRequest(size_t offset)
{
    ...
    if (rc)
    {
        // Handle error scenario
        error(
            "Send UpdateComponent request for endpoint ID '{EID}' failed with response code '{RC}'",
            "EID", unsigned(eid), "RC", rc);
    }
}
                                    ...
                                    size_t respMsgLen)
{
    ...
    {
        // Handle error scenario
        error("No response received for updateComponent with endpoint ID {EID}",
              "EID", unsigned(eid));
        return;
    }
    ...
    {
        error(
            "Decoding UpdateComponent response for endpoint ID '{EID}' failed with response code '{RC}'",
            "EID", unsigned(eid), "RC", rc);
        return;
    }
    if (completionCode)
    {
        error(
            "UpdateComponent response for endpoint ID '{EID}' failed with completion code '{CC}'",
            "EID", unsigned(eid), "CC", unsigned(completionCode));
        return;
    }
}
                                      ...
                                      size_t payloadLength)
{
    ...
    {
        error(
            "Decoding RequestFirmwareData request for endpoint ID '{EID}' failed with response code '{RC}'",
            "EID", unsigned(eid), "RC", rc);
        ...
        {
            error(
                "Encoding RequestFirmwareData response for endpoint ID '{EID}' failed with response code '{RC}'",
                "EID", unsigned(eid), "RC", rc);
        }
        return response;
    }
                                       ...
                                       size_t payloadLength)
{
    ...
    {
        error(
            "Decoding VerifyComplete request of endpoint ID '{EID}' failed with response code '{RC}'",
            "EID", unsigned(eid), "RC", rc);
        ...
        {
            error(
                "Encoding VerifyComplete response of endpoint ID '{EID}' failed with response code '{RC}'.",
                "EID", unsigned(eid), "RC", rc);
        }
        return response;
    }
    ...
    {
        error(
            "Encoding VerifyComplete response for endpoint ID '{EID}' failed with response code - {RC}",
            "EID", unsigned(eid), "RC", rc);
        return response;
    }
                                      ...
                                      size_t payloadLength)
{
    ...
    {
        error(
            "Decoding ApplyComplete request for endpoint ID '{EID}' failed with response code '{RC}'",
            "EID", unsigned(eid), "RC", rc);
        ...
        {
            error(
                "Encoding ApplyComplete response for endpoint ID '{EID}' failed with response code '{RC}'",
                "EID", unsigned(eid), "RC", rc);
        }
        return response;
    }
...
void DeviceUpdater::sendActivateFirmwareRequest()
{
    ...
    {
        error(
            "Send ActivateFirmware request for endpoint ID '{EID}' failed with response code '{RC}'",
            "EID", unsigned(eid), "RC", rc);
    }
}
                                     ...
                                     size_t respMsgLen)
{
    if (response == nullptr || !respMsgLen)
    {
        // Handle error scenario
        error(
            "No response received for ActivateFirmware for endpoint ID '{EID}'",
            "EID", eid);
        return;
    }
    ...
    if (rc)
    {
        // Handle error scenario
        error(
            "Decoding ActivateFirmware response for endpoint ID '{EID}' failed with response code '{RC}'",
            "EID", eid, "RC", rc);
        return;
    }
    if (completionCode)
    {
        // Handle error scenario
        error(
            "ActivateFirmware response for endpoint ID '{EID}' failed with completion code '{CC}'",
