...
{
    // Set selfContainedActivationReq if any component supports self-contained
    // activation.
    selfContainedActivationReq =
        std::ranges::any_of(compInfo, [](const auto& comp) {
            return comp.second.selfContainedActivation;
        });
