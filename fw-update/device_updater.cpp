...
void DeviceUpdater::sendPassCompTableRequest(size_t offset)
{
    ...
    const auto compVersion = utils::toString(
        comp.component_version_string);
...
void DeviceUpdater::sendUpdateComponentRequest(size_t offset)
{
    ...
    auto compImage =
        CompImage{comp.component_image.ptr,
                            comp.component_image.ptr +
                                comp.component_image.length};
    ...
    auto rc = encode_update_component_req(
        ...
        comp.component_comparison_stamp,
                                      ...
                                      size_t payloadLength)
{
    ...
    const auto compImage = CompImage{
        comp.component_image.ptr,
        comp.component_image.ptr + comp.component_image.length};
    const auto& compImageSize = compImage.size();
