...
class UpdateManager
{
  public:
     ...
     *
     */
    void createMessageRegistry(const mctp_eid_t eid,
    ...
    /** @brief Method to find Activation Method based on PLDM response.
     *
     *  @param[in] compActivationModification - PLDM response code
     *
     *  @return PLDM appropritate string message as per PLDM FU spec.
     */
    const std::string
        getActivationMethod(bitfield16_t& compActivationModification);
