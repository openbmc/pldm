...
class ItemUpdateManager : public UpdateManagerBase, public UpdateIntf
{
  public:
    ...
    explicit ItemUpdateManager(
        ...
        const std::string& softwareHash, const Descriptors& descriptors,
        const ComponentInfo& componentInfo) :
        UpdateManagerBase(event, handler, instanceIdDb),
        UpdateIntf(pldm::utils::DBusHandler::getBus(),
                   std::format("{}_{}", objPath, softwareHash).c_str()),
