...
class ItemUpdateManager : public UpdateManagerBase, public ItemUpdateIntf
{
  ...
  private:
    ...
    /**
     * @brief Build post-condition arguments including applyTime
     *
     * Formats the condition arguments for post-condition services.
     * If both conditionArg and applyTime exist, they are combined with a comma.
     * Format: "originalArg,applyTime=<value>"
     *
     * @return Formatted argument string for post-condition service
     */
    std::string buildPostConditionArgs() const;
