    ...
    size_t offset)
{
    ...
    while (deviceIdRecCount-- && (pkgHdrRemainingSize > 0))
    {
        ...
        fwDeviceIDRecords.emplace_back(std::make_tuple(
            ...
            ApplicableComponents{applicableComponents.ptr,
                                             ...
                                             size_t offset)
{
    ...
    while (compImageCount-- && (pkgHdrRemainingSize > 0))
    {
        ...
        CompComparisonTime compComparisonTime =
...
void PackageParser::validatePkgTotalSize(uintmax_t pkgSize)
{
    ...
    {
        CompLocationOffset compLocOffset = std::get<5>(componentImageInfo);
        CompSize compSize = std::get<6>(componentImageInfo);
