...
void FirmwareInventoryManager::emplace(
...
void FirmwareInventoryManager::removeById(const mctp_eid_t& eid)
{
...
std::string FirmwareInventoryManager::getVersionId(const std::string& version)
{
    if (version.empty())
    {
...
Response FirmwareInventoryManager::handleRequest(
