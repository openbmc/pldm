...
void InventoryItemManager::createInventoryItem(
    ...
    DescriptorMap&& descriptorMap [[maybe_unused]],
    ComponentInfoMap&& componentInfoMap [[maybe_unused]])
{
