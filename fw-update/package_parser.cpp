...
void pkg::WrapPackageParser::parse(const std::vector<uint8_t>& pkgHdr)
{
    ...
    for (const pldm::fw_update::ComponentImageInfo& cii :
    ...
    for (const pldm::fw_update::FirmwareDeviceIDRecord& fdir :
