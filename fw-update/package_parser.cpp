...
void PackageParser::parse(std::span<const uint8_t> package)
{
    ...
    foreach_pldm_package_firmware_device_id_record(pkg,
    ...
    foreach_pldm_package_downstream_device_id_record(pkg,
    ...
    foreach_pldm_package_component_image_information(pkg, compImageInfo,
                                                     rc)
    {
