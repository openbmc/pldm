...
void PackageParser::parse(std::span<const uint8_t> package)
{
            ...
            pkg, firmwareDeviceIdRecord, descriptorData, rc)
        {
            ...
            else
            {
                ...
                rc = decode_vendor_defined_descriptor_value(
                    descriptorDataPtr, descriptorLength, &descriptorTitleStrType,
                ...
                descriptors.emplace(
                    descriptorType,
                    std::make_tuple(utils::toString(descriptorTitleStr),
    ...
    foreach_pldm_package_component_image_information(pkg, firmwareDeviceIdRecord, rc)
    {
