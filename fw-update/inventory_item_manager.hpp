...
class Software;
using ActivationBlocksTransitionIntf = sdbusplus::aserver::xyz::
    openbmc_project::software::ActivationBlocksTransition<Software>;
using SoftwareActivationIntf =
...
class Software
{
  ...
  private:
    ...
    std::unique_ptr<ActivationBlocksTransitionIntf> blocksTransition;
    std::unique_ptr<SoftwareActivationIntf> activation;
