...
TEST(PackageParser, ValidPkgSingleDescriptorSingleComponent)
{
    ...
    auto outCompImage = CompImage{outCompImageInfo.component_image.ptr,
                                  outCompImageInfo.component_image.ptr +
                                      outCompImageInfo.component_image.length};
    EXPECT_EQ(outCompImage, compImage);
    EXPECT_EQ(pldm::utils::toString(outCompImageInfo.component_version_string),
              "VersionString3");
}
...
TEST(PackageParser, ValidPkgMultipleDescriptorsMultipleComponents)
{
    ...
    auto outCompImage1 =
        CompImage{outCompImageInfo1.component_image.ptr,
                  outCompImageInfo1.component_image.ptr +
                      outCompImageInfo1.component_image.length};
    EXPECT_EQ(outCompImage1, compImage1);
    EXPECT_EQ(pldm::utils::toString(outCompImageInfo1.component_version_string),
              "VersionString5");
    ...
    EXPECT_EQ(pldm::utils::toString(outCompImageInfo2.component_version_string),
              "VersionString6");
    ...
    EXPECT_EQ(pldm::utils::toString(outCompImageInfo3.component_version_string),
              "VersionString7");
}
