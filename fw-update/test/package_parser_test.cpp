...
TEST(PackageParser, ValidPkgSingleDescriptorSingleComponent)
{
    ...
    EXPECT_EQ(pldm::utils::toString(outCompImageInfo.component_version),
              "VersionString3");
}
...
TEST(PackageParser, ValidPkgMultipleDescriptorsMultipleComponents)
{
    ...
    EXPECT_EQ(pldm::utils::toString(outCompImageInfo1.component_version),
              "VersionString5");
    ...
    EXPECT_EQ(pldm::utils::toString(outCompImageInfo2.component_version),
              "VersionString6");
    ...
    EXPECT_EQ(pldm::utils::toString(outCompImageInfo3.component_version),
              "VersionString7");
}
