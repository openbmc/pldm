...
#include "fw-update/fw_inventory_manager.hpp"
...
class InventoryManagerTest : public testing::Test
{
  protected:
    InventoryManagerTest() :
        ...
        reqHandler(fd, event, dbusImplRequester, seconds(1), 2,
                   milliseconds(100)),
...
TEST_F(InventoryManagerTest, handleQueryDeviceIdentifiersResponseErrorCC)
{
    ...
    inventoryManager.queryDeviceIdentifiersRespHandler(1, responseMsg,
                                                       respPayloadLength);
...
TEST_F(InventoryManagerTest, handleQueryDeviceIdentifiersResponse)
{
    ...
    inventoryManager.queryDeviceIdentifiersRespHandler(1, responseMsg1,
                                                       respPayloadLength1);
    ...
    inventoryManager.queryDeviceIdentifiersRespHandler(2, responseMsg2,
                                                       respPayloadLength2);
...
TEST_F(InventoryManagerTest, getFirmwareParametersResponseErrorCC)
{
    ...
    inventoryManager.getFirmwareParametersRespHandler(1, responseMsg,
                                                       respPayloadLength);
...
TEST_F(InventoryManagerTest, getFirmwareParametersResponse)
{
    ...
    inventoryManager.getFirmwareParametersRespHandler(1, responseMsg1,
                                                      respPayloadLength1);
    ...
    inventoryManager.getFirmwareParametersRespHandler(2, responseMsg2,
                                                      respPayloadLength2);
