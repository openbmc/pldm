...
class DeviceUpdaterTest : public testing::Test
{
  protected:
        ...
        package("./test_pkg", std::ios::binary | std::ios::in | std::ios::ate)
    {
        ...
        compImageInfos = {compImageInfo, compImage, "VersionString3"};
...
TEST_F(DeviceUpdaterTest, validatePackage)
{
    ...
    const auto& outCompImage =
        std::get<CompImage>(outCompImageInfo);
    const auto& outCompVersion =
        std::get<CompVersion>(outCompImageInfoTuple);
