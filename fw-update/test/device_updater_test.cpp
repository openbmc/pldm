...
class DeviceUpdaterTest : public testing::Test
{
  protected:
        ...
        package("./test_pkg", std::ios::binary | std::ios::in | std::ios::ate)
    {
        ...
        compImageInfos = {std::move(compImageInfo)};
...
TEST_F(DeviceUpdaterTest, validatePackage)
{
    ...
    auto& outCompImageInfo = testPkgCompImageInfos[0];
    ...
    auto compImage = CompImage{compImageInfos[0].component_image.ptr,
                               compImageInfos[0].component_image.ptr +
                                   compImageInfos[0].component_image.length};
