...
TEST_F(InventoryManagerTest, handleQueryDeviceIdentifiersResponse)
{
    ...
    const auto responseMsg1 =
        new (const_cast<void*>(queryDeviceIdentifiersResp1.data())) pldm_msg;
    ...
    const auto responseMsg2 =
        new (const_cast<void*>(queryDeviceIdentifiersResp2.data())) pldm_msg;
...
TEST_F(InventoryManagerTest, handleQueryDeviceIdentifiersResponseErrorCC)
{
    ...
    auto responseMsg =
        new (const_cast<void*>(queryDeviceIdentifiersResp.data())) pldm_msg;
...
TEST_F(InventoryManagerTest, handleQueryDownstreamIdentifierResponseErrorCC)
{
    ...
    auto responseMsg =
        new (const_cast<void*>(queryDownstreamIdentifiersResp.data())) pldm_msg;
...
TEST_F(InventoryManagerTest, handleGetDownstreamFirmwareParametersResponse)
{
    ...
    auto responseMsg =
        new (const_cast<void*>(getDownstreamFwParametersResp.data())) pldm_msg;
...
TEST_F(InventoryManagerTest, getFirmwareParametersResponse)
{
    ...
    constexpr std::array<uint8_t, sizeof(pldm_msg_hdr) + respPayloadLength1>
        getFirmwareParametersResp1{
            ...
            0x30};
    auto responseMsg1 =
        new (const_cast<void*>(getFirmwareParametersResp1.data())) pldm_msg;
    ...
    auto responseMsg2 =
        new (const_cast<void*>(getFirmwareParametersResp2.data())) pldm_msg;
...
TEST_F(InventoryManagerTest, getFirmwareParametersResponseErrorCC)
{
    ...
    auto responseMsg = new (const_cast<void*>(getFirmwareParametersResp.data()))
        pldm_msg;
