...
TEST_F(InventoryManagerTest, handleQueryDeviceIdentifiersResponse)
{
    ...
    auto responseMsg1 = new (queryDeviceIdentifiersResp1.data()) pldm_msg;
    ...
    auto responseMsg2 = new (queryDeviceIdentifiersResp2.data()) pldm_msg;
...
TEST_F(InventoryManagerTest, handleQueryDeviceIdentifiersResponseErrorCC)
{
    ...
    auto responseMsg = new (queryDeviceIdentifiersResp.data()) pldm_msg;
...
TEST_F(InventoryManagerTest, handleGetDownstreamFirmwareParametersResponse)
{
    ...
    auto responseMsg = new (getDownstreamFwParametersResp.data()) pldm_msg;
...
TEST_F(InventoryManagerTest, getFirmwareParametersResponse)
{
    ...
    constexpr std::array<uint8_t, sizeof(pldm_msg_hdr) + respPayloadLength1>
        getFirmwareParametersResp1{
            ...
            0x30};
    auto responseMsg1 = new (getFirmwareParametersResp1.data()) pldm_msg;
    ...
    auto responseMsg2 = new (getFirmwareParametersResp2.data()) pldm_msg;
...
TEST_F(InventoryManagerTest, getFirmwareParametersResponseErrorCC)
{
    ...
    auto responseMsg = new (getFirmwareParametersResp.data()) pldm_msg;
