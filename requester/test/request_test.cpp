...
{
    MockRequest request(fd, *pldmTransport, eid, event, std::move(requestMsg),
                        0, milliseconds(100), 90000, false);
...
{
    MockRequest request(fd, *pldmTransport, eid, event, std::move(requestMsg),
                        2, milliseconds(100), 90000, false);
...
{
    MockRequest request(fd, *pldmTransport, eid, event, std::move(requestMsg),
                        9, milliseconds(100), 90000, false);
