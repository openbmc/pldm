             ...
             mctpReactorObjectPath](sdbusplus::message_t& msg) mutable {
                        ...
                        "xyz.openbmc_project.Association.Definitions"))
                {
                    ...
                    if (this->resolveAssociation(mctpInfo))
                    {
                        ...
                        // Note: The order here is important to avoid memory
                        // conflicts.
                        this->removeBeforeAdd(MctpInfos(1, mctpInfo));

                        // Since 'removeBeforeAdd' might have cleared
                        // configurations, we ensure the resolved path is
                        // re-added to configurations.
