...
TEST(setStateEffecterStatesHandler, testGoodRequest)
{
    ...
    EXPECT_CALL(handlerObj, setDbusProperty(objPath, bootProgressProp,
        ...
        .Times(2);
    auto rc = pldm::responder::platform_11::setStateEffecterStatesHandler<
        MockdBusHandler11>(handlerObj, 0x1, stateField);
    ASSERT_EQ(rc, 0);
}
...
TEST(setStateEffecterStatesHandler, testBadRequest)
{
    ...
    rc = pldm::responder::platform_11::setStateEffecterStatesHandler<
        MockdBusHandler11>(handlerObj, 0x9, stateField);
    ...
    rc = pldm::responder::platform_11::setStateEffecterStatesHandler<
        MockdBusHandler11>(handlerObj, 0x2, newStateField);
