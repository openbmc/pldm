...
class NumericEffecter
{
  public:
     ...
     */
    sdbusplus::async::task<int> setNumericEffecterEnable(
     ...
     */
    sdbusplus::async::task<int> setNumericEffecterValue(double effecterValue);

    /** @brief Sending getNumericEffecterValue command for the effecter
     */
    sdbusplus::async::task<int> getNumericEffecterValue();
