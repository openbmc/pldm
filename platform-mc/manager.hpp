  ...
  public:
                        ...
                        size_t eventDataOffset)
    {
        ...
        eventManager.handlePlatformEvent(
            tid, PLDM_OEM_EVENT_CLASS_0xFA, eventData, eventDataSize);
        return PLDM_SUCCESS;
    }
                                   ...
                                   size_t eventDataOffset)
    {
        ...
        auto eventDataSize = payloadLength - eventDataOffset;
        eventManager.handlePlatformEvent(
            tid, PLDM_MESSAGE_POLL_EVENT, eventData, eventDataSize);
        return PLDM_SUCCESS;
    }
                          ...
                          size_t eventDataOffset)
    {
        ...
        auto eventDataSize = payloadLength - eventDataOffset;
        eventManager.handlePlatformEvent(
            tid, PLDM_SENSOR_EVENT, eventData, eventDataSize);
        return PLDM_SUCCESS;
    }
#ifdef OEM_META
                           ...
                           size_t eventDataOffset)
    {
        ...
        auto eventDataSize = payloadLength - eventDataOffset;
        eventManager.handlePlatformEvent(
            tid, PLDM_OEM_EVENT_CLASS_0xFB, eventData, eventDataSize);
        return PLDM_SUCCESS;
    }
#endif
