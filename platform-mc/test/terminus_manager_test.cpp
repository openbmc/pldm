...
TEST_F(TerminusManagerTest, discoverMctpTerminusTest)
{
    ...
    rc = mockTerminusManager.enqueueResponse(std::start_lifetime_as<pldm_msg>(getTidResp0.data()),
                                             sizeof(getTidResp0));
    EXPECT_EQ(rc, PLDM_SUCCESS);
    std::array<uint8_t, sizeof(pldm_msg_hdr) + setTidRespLen> setTidResp0{
        0x00, 0x02, 0x01, 0x00};
    rc = mockTerminusManager.enqueueResponse(std::start_lifetime_as<pldm_msg>(setTidResp0.data()),
                                             sizeof(setTidResp0));
    EXPECT_EQ(rc, PLDM_SUCCESS);
    ...
    rc = mockTerminusManager.enqueueResponse(
        std::start_lifetime_as<pldm_msg>(getPldmTypesResp0.data()), sizeof(getPldmTypesResp0));
    EXPECT_EQ(rc, PLDM_SUCCESS);
    ...
    rc = mockTerminusManager.enqueueResponse(std::start_lifetime_as<pldm_msg>(getTidResp1.data()),
                                             sizeof(getTidResp1));
    EXPECT_EQ(rc, PLDM_SUCCESS);
    rc = mockTerminusManager.enqueueResponse(std::start_lifetime_as<pldm_msg>(setTidResp0.data()),
                                             sizeof(setTidResp0));
...
TEST_F(TerminusManagerTest, negativeDiscoverMctpTerminusTest)
{
    ...
    auto rc = mockTerminusManager.enqueueResponse(
        std::start_lifetime_as<pldm_msg>(getTidResp0.data()), sizeof(getTidResp0));
    EXPECT_EQ(rc, PLDM_SUCCESS);
    ...
    rc = mockTerminusManager.enqueueResponse(std::start_lifetime_as<pldm_msg>(getTidResp1.data()),
                                             sizeof(getTidResp1));
    EXPECT_EQ(rc, PLDM_SUCCESS);
    rc = mockTerminusManager.enqueueResponse(std::start_lifetime_as<pldm_msg>(setTidResp1.data()),
                                             sizeof(setTidResp1));
    EXPECT_EQ(rc, PLDM_SUCCESS);
    mockTerminusManager.removeMctpTerminus(mctpInfos);
    EXPECT_EQ(0, termini.size());
    ...
    std::array<uint8_t, sizeof(pldm_msg_hdr) + getPldmTypesRespLen>
        getPldmTypesResp2{0x00, 0x02, 0x04, PLDM_ERROR, 0x01, 0x00,
                          0x00, 0x00, 0x00, 0x00,       0x00, 0x00};
    rc = mockTerminusManager.enqueueResponse(std::start_lifetime_as<pldm_msg>(getTidResp2.data()),
                                             sizeof(getTidResp2));
    EXPECT_EQ(rc, PLDM_SUCCESS);
    rc = mockTerminusManager.enqueueResponse(std::start_lifetime_as<pldm_msg>(setTidResp2.data()),
                                             sizeof(setTidResp2));
    EXPECT_EQ(rc, PLDM_SUCCESS);

    rc = mockTerminusManager.enqueueResponse(
        std::start_lifetime_as<pldm_msg>(getPldmTypesResp2.data()), sizeof(getPldmTypesResp2));
    EXPECT_EQ(rc, PLDM_SUCCESS);
    mockTerminusManager.removeMctpTerminus(mctpInfos);
    EXPECT_EQ(0, termini.size());
}
