...
{
    // A terminus with an inventory object gets the component sensor linked to
    // it, and reads its state as any other one.
    auto info = makeInfo(2, {{PLDM_STATE_SET_HEALTH_STATE, {1, 2}}});
    pldm::platform_mc::StateSensor sensor(
        0x01, info, 0, "health", "S0_Sensor_2",
        "/xyz/openbmc_project/inventory/system/board/S0");
