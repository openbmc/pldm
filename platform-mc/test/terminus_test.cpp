...
TEST(TerminusTest, createPldmEntityTest)
{
    ...
    // clang-format off
    std::array<EntityTestCase, 11> testCases = {{
...
TEST(TerminusTest, parseEntityAssociationPDRTest)
{
    ...
    EXPECT_EQ("/xyz/openbmc_project/inventory/system/Terminus_1_Cpu_2",
...
TEST(TerminusTest, addStateSensorTest)
{
    ...
    EXPECT_EQ("/xyz/openbmc_project/inventory/system/Terminus_1_PowerSupply_1",
              entity->getPath());
