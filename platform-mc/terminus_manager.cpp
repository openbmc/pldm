    ...
    if (responseTid != PLDM_TID_UNASSIGNED && responseTid != tid)
    {
        ...
        if (it != termini.end())
        {
            ...
            else
            {
                 ...
                 *
                 * Current implementation uses the first discovered MCTP
                 * network/interface to avoid duplicate discovery of the same
                 * device.
                 *
                 * TODO: Implement a policy-based approach to select the
                 * preferred MCTP network/interface based on performance
                 * characteristics (e.g., fastest available interface) for
