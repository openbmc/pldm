                                       ...
                                       const std::string& inventoryPath)
{
    ...
    /* A terminus without an inventory object has no item to link to. */
    ...
    /* The health reported here is the health of the inventory item, not of
     * this object, so this object is monitoring that item. */
