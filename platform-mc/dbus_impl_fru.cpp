...
uint16_t PldmEntityReq::entityType(uint16_t value)
{
    return entityserver::entityType(value);
}

uint16_t PldmEntityReq::entityInstanceNumber(uint16_t value)
{
    return entityserver::entityInstanceNumber(value);
}

uint16_t PldmEntityReq::containerID(uint16_t value)
{
