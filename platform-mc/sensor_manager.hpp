...
class SensorManager
{
  ...
  protected:
    ...
    /** @brief get priority sensor name space list in json file
     *
     *  @param[in] configJson - configation json file path
     */
    void getPrioritySensorNameSpaces(const std::filesystem::path& configJson);
