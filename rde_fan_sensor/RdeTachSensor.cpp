...
TachSensor::TachSensor(const std::string &name,
                       ...
                       bool isValueMutable) : objectServer(objectServer), name(name), rdeDevObjPath(rdeDevObjPath)
{
    ...
    sensorInterface->register_property("Unit", std::string("xyz.openbmc_project.Sensor.Value.Unit.RPMS"));
