 ...
 *                              information
 *  @return[out] true means parse success and get a valid
 *               set_effecter_state_field structure, false means parse failed
 *               and get an invalid set_effecter_state_field structure
 */
