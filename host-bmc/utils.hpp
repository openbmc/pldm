...
const std::map<EntityType, EntityName> entityMaps = {
    ...
    {PLDM_ENTITY_VIRTUAL_MACHINE_MANAGER | 0x8000, "vmm"},
    {PLDM_ENTITY_IO_MODULE, "io_module"},
    {PLDM_ENTITY_FAN, "fan"},
    {PLDM_ENTITY_SYS_MGMT_MODULE, "cmc"},
    {PLDM_ENTITY_COMM_CHANNEL | 0x8000, "comm_channel"},
    {PLDM_ENTITY_CHASSIS_FRONT_PANEL_BOARD | 0x8000, "panel"},
    {8192 | 0x8000, "dump"},
    {PLDM_ENTITY_POWER_CONVERTER, "power_converter"},
    {PLDM_ENTITY_SLOT, "slot"},
    {PLDM_ENTITY_CONNECTOR, "connector"},
    {PLDM_ENTITY_GROUP | 0x8000, "group"},
    {24578 | 0x8000, "ipv4"},
    {24579 | 0x8000, "ipv6"},
    {PLDM_ENTITY_PCI_EXPRESS_BUS | 0x8000, "pcibus"}};
