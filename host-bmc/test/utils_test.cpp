...
TEST(EntityAssociation, addObjectPathEntityAssociations1)
{
    ...
    auto l2c = pldm_entity_association_tree_add(
        tree, &entities[3], 0, l1, PLDM_ENTITY_ASSOCIAION_PHYSICAL, true);
    auto l2d = pldm_entity_association_tree_add(
        tree, &entities[4], 24, l1, PLDM_ENTITY_ASSOCIAION_PHYSICAL, true);
    auto l2e = pldm_entity_association_tree_add(
        tree, &entities[5], 32, l1, PLDM_ENTITY_ASSOCIAION_PHYSICAL, true);
    auto l2f = pldm_entity_association_tree_add(
        tree, &entities[6], 56, l1, PLDM_ENTITY_ASSOCIAION_PHYSICAL, true);
    ...
    ObjectPathMaps retObjectMaps = {
        ...
        {"/xyz/openbmc_project/inventory/motherboard1/dimm0", l2c},
        {"/xyz/openbmc_project/inventory/motherboard1/dimm24", l2d},
        {"/xyz/openbmc_project/inventory/motherboard1/dimm32", l2e},
        {"/xyz/openbmc_project/inventory/motherboard1/dimm56", l2f}};
