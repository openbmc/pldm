...
class HostPDRHandler
{
  public:
     ...
     *  @param[in] tid - Terminus id of pldm terminus
     *  @param[in] terminusHandle - Terminus Handle of PLDM terminus
     *  @param[in] validity - Terminus locator pdr valid bit
     *  @param[in] eid - enpoint id of the pldm terminus
     */
