        ...
        else
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    std::cout
                        << __PRETTY_FUNCTION__
                        << " : Inside else of if (!tlValid), modifiedPDRRecordHandles size : "
                        << modifiedPDRRecordHandles.size() << std::endl;
                    if (!modifiedPDRRecordHandles.empty())
                    {
                        std::cout
                            << __PRETTY_FUNCTION__
                            << " : modifiedPDRRecordHandles is not empty, size : "
                            << modifiedPDRRecordHandles.size() << std::endl;
                        ...
                        std::cout
                            << __PRETTY_FUNCTION__
                            << "Popped modifiedPDRRecordHandles. Current size :  "
                            << modifiedPDRRecordHandles.size() << std::endl;
                    }
                    else
                    {
                        std::cout
                            << __PRETTY_FUNCTION__ << " : else..." << std::endl;
                        pldm_delete_by_record_handle(repo, rh, true);
