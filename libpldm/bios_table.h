 ...
 *  @param[in] entry
 *  @param[in] entry_length 
 *  @param[in] attr_handle - This handle points to an attribute in the 
 *  BIOS Attribute Vlaue Table.
 *  @param[in] attr_type - Type of this attribute in the BIOS Attribute Value Table
 *  @param[in] count - Total number of current values for this enum attribute
 *  @param[in] handle_indexes - Index into the array(provided in the BIOS Attribute Table)
 *  of the possible values of string handles for this attribute.
 *  @return pldm_completion_codes
 */
 ...
 *  BIOS Attribute Vlaue Table.
 *  @param[in] attr_type - Type of this attribute in the BIOS Attribute Value Table
 *  @param[in] string_length - Length of current string in bytes. 0 indicates that
 *  the current string value is not set.
