 ...
 *  @param[in] entry - Pointer to bios attribute value table entry
 *  @param[out] handles - Pointer to a buffer to stroe
 ...
 *  @param[in] entry - Pointer to bios attribute value table entry
 *  @param[out] current_string - Struct variable_field, contains a pointer to
 *                               the CurrentString field in the buffer of
