 ...
 *         and for appending the FRU table to the msg.
 */
int encode_get_fru_record_by_option_resp(
    uint8_t instance_id, uint8_t completion_code, uint32_t data_transfer_handle,
    uint8_t transfer_flag, const void *fru_structure_data, size_t data_size,
 ...
 *  @param[out] record_table - The table got by options
 *  @param[in/out] record_size - Size of the table got by options
 *  @param[in] rsi - The record set identifier
 *  @param[in] rt - The record type
 *  @param[in] ft - The filed type
 */
