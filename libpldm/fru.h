 ...
 * FRU Record Table
 *  @param[out] fru_record_table_length - Length of the FRU record table data
 *  @param[in] max_fru_record_table_length - Maximum length of the FRU record table data. If
 * the response contains more data than this, return PLDM_ERROR_INVALID_LENGTH.
 *  @return pldm_completion_codes
 */
