 ...
 *
 *  @param[in] seconds - seconds in dec format
 *  @param[in] minutes - minutes in dec format
 *  @param[in] hours - hours in dec format
 *  @param[in] day - day in dec format . Value range 1~31
 *  @param[in] month - month in dec format . Value range 1~12
 *  @param[in] year - year in dec format
