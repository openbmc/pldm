...
TEST(PlatformEventMessage, testGoodNumericSensorEventDataDecodeRequest)
{
    ...
    sensorData->present_reading[3] =
        (htole32(presentReading) & htole32(0x000000ff));
    sensorData->present_reading[2] =
        (htole32(presentReading) & htole32(0x0000ff00)) >> 8;
    sensorData->present_reading[1] =
        (htole32(presentReading) & htole32(0x00ff0000)) >> 16;
    sensorData->present_reading[0] =
        (htole32(presentReading) & htole32(0xff000000)) >> 24;
    ...
    sensorData->present_reading[1] =
        (htole16(presentReadingNew) & htole16(0x000000ff));
    sensorData->present_reading[0] =
        (htole16(presentReadingNew) & htole16(0x0000ff00)) >> 8;
