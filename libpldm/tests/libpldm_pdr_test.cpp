...
TEST(EntityAssociationPDR, testBuild)
{
    ...
    pldm_entity parent = pldm_entity_get_parent(l1);
    EXPECT_EQ(parent.entity_type, 0);
    EXPECT_EQ(parent.entity_instance_num, 0);
    EXPECT_EQ(parent.entity_container_id, 0);
    ...
    pldm_entity parentL3a = pldm_entity_get_parent(l2a);
    pldm_entity parentL3b = pldm_entity_get_parent(l2b);
    pldm_entity parentL3c = pldm_entity_get_parent(l2c);
