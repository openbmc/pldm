...
TEST(EntityAssociationPDR, testBuild)
{
    ...
    auto l1 = pldm_entity_association_tree_add(tree, &entities[0], 0xFFFF,
                                               nullptr, nullptr,
                                               PLDM_ENTITY_ASSOCIAION_PHYSICAL);
    EXPECT_NE(l1, nullptr);
    auto l2a =
        pldm_entity_association_tree_add(tree, &entities[1], 0xFFFF, nullptr,
                                         l1, PLDM_ENTITY_ASSOCIAION_PHYSICAL);
    EXPECT_NE(l2a, nullptr);
    auto l2b =
        pldm_entity_association_tree_add(tree, &entities[2], 0xFFFF, nullptr,
                                         l1, PLDM_ENTITY_ASSOCIAION_PHYSICAL);
    EXPECT_NE(l2b, nullptr);
    auto l2c =
        pldm_entity_association_tree_add(tree, &entities[3], 0xFFFF, nullptr,
                                         l1, PLDM_ENTITY_ASSOCIAION_PHYSICAL);
    EXPECT_NE(l2c, nullptr);
    auto l3a =
        pldm_entity_association_tree_add(tree, &entities[4], 0xFFFF, nullptr,
                                         l2a, PLDM_ENTITY_ASSOCIAION_PHYSICAL);
    EXPECT_NE(l3a, nullptr);
    auto l3b =
        pldm_entity_association_tree_add(tree, &entities[5], 0xFFFF, nullptr,
                                         l2a, PLDM_ENTITY_ASSOCIAION_PHYSICAL);
    EXPECT_NE(l3b, nullptr);
    auto l3c =
        pldm_entity_association_tree_add(tree, &entities[6], 0xFFFF, nullptr,
                                         l2a, PLDM_ENTITY_ASSOCIAION_PHYSICAL);
    EXPECT_NE(l3b, nullptr);
    auto l4a =
        pldm_entity_association_tree_add(tree, &entities[7], 0xFFFF, nullptr,
                                         l3a, PLDM_ENTITY_ASSOCIAION_PHYSICAL);
    EXPECT_NE(l4a, nullptr);
    auto l4b =
        pldm_entity_association_tree_add(tree, &entities[8], 0xFFFF, nullptr,
                                         l3b, PLDM_ENTITY_ASSOCIAION_PHYSICAL);
    ...
    pldm_entity_association_tree_visit(pldm_entity_root_extract(tree), &out,
                                       &num);
    EXPECT_EQ(num, 9u);
...
TEST(EntityAssociationPDR, testSpecialTrees)
{
    ...
    auto node = pldm_entity_association_tree_add(
        tree, &entities[0], 0xFFFF, nullptr, nullptr,
        PLDM_ENTITY_ASSOCIAION_PHYSICAL);
    ...
    auto node1 =
        pldm_entity_association_tree_add(tree, &entities[1], 0xFFFF, nullptr,
                                         node, PLDM_ENTITY_ASSOCIAION_PHYSICAL);
    EXPECT_NE(node1, nullptr);
    auto node2 = pldm_entity_association_tree_add(
        tree, &entities[2], 0xFFFF, nullptr, node1,
        PLDM_ENTITY_ASSOCIAION_PHYSICAL);
...
TEST(EntityAssociationPDR, testPDR)
{
    ...
    auto l1a = pldm_entity_association_tree_add(
        tree, &entities[1], 0xFFFF, nullptr, nullptr,
        PLDM_ENTITY_ASSOCIAION_PHYSICAL);
    ...
    auto l4a =
        pldm_entity_association_tree_add(tree, &entities[9], 0xFFFF, nullptr,
                                         l3a, PLDM_ENTITY_ASSOCIAION_PHYSICAL);
    EXPECT_NE(l4a, nullptr);
    auto l4b =
        pldm_entity_association_tree_add(tree, &entities[10], 0xFFFF, nullptr,
...
TEST(EntityAssociationPDR, testCopyTree)
{
    ...
    auto l1 = pldm_entity_association_tree_add(orgTree, &entities[0], 0xFFFF,
                                               nullptr, nullptr,
                                               PLDM_ENTITY_ASSOCIAION_PHYSICAL);
    EXPECT_NE(l1, nullptr);
    auto l2a =
        pldm_entity_association_tree_add(orgTree, &entities[1], 0xFFFF, nullptr,
                                         l1, PLDM_ENTITY_ASSOCIAION_PHYSICAL);
    EXPECT_NE(l2a, nullptr);
    auto l2b =
        pldm_entity_association_tree_add(orgTree, &entities[2], 0xFFFF, nullptr,
                                         l1, PLDM_ENTITY_ASSOCIAION_PHYSICAL);
    EXPECT_NE(l2b, nullptr);
    auto l2c =
        pldm_entity_association_tree_add(orgTree, &entities[3], 0xFFFF, nullptr,
                                         l1, PLDM_ENTITY_ASSOCIAION_PHYSICAL);
    EXPECT_NE(l2c, nullptr);
    size_t orgNum{};
    pldm_entity* orgOut = nullptr;
    pldm_entity_association_tree_visit(pldm_entity_root_extract(orgTree),
                                       &orgOut, &orgNum);
    EXPECT_EQ(orgNum, 4u);
    ...
    pldm_entity_association_tree_visit(pldm_entity_root_extract(newTree),
                                       &newOut, &newNum);
...
TEST(EntityAssociationPDR, testEntityInstanceNumber)
{
    ...
    auto l1 = pldm_entity_association_tree_add(
        tree, &entities[1], 63, nullptr, node, PLDM_ENTITY_ASSOCIAION_PHYSICAL);
    ...
    auto l2 = pldm_entity_association_tree_add(
        tree, &entities[2], 37, nullptr, node, PLDM_ENTITY_ASSOCIAION_PHYSICAL);
    ...
    auto l3 = pldm_entity_association_tree_add(
        tree, &entities[3], 44, nullptr, node, PLDM_ENTITY_ASSOCIAION_PHYSICAL);
    ...
    auto l4 = pldm_entity_association_tree_add(
        tree, &entities[4], 89, nullptr, node, PLDM_ENTITY_ASSOCIAION_PHYSICAL);
    ...
    auto l6 = pldm_entity_association_tree_add(
        tree, &entities[6], 90, nullptr, node, PLDM_ENTITY_ASSOCIAION_PHYSICAL);
    EXPECT_EQ(l6, nullptr);

    auto l7 =
        pldm_entity_association_tree_add(tree, &entities[7], 100, &entities[1],
                                         l1, PLDM_ENTITY_ASSOCIAION_PHYSICAL);
    ...
    auto l8 =
        pldm_entity_association_tree_add(tree, &entities[8], 100, &entities[2],
                                         l2, PLDM_ENTITY_ASSOCIAION_PHYSICAL);
