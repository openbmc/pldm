...
TEST(EntityAssociationPDR, testGetChildren)
{
    ...
    EXPECT_EQ(true, pldm_is_currect_parent_child(l1, et1));

    pldm_entity et2;
    et2.entity_type = 2;
    et2.entity_instance_num = 2;
    EXPECT_EQ(true, pldm_is_currect_parent_child(l1, et2));

    pldm_entity et3;
    et3.entity_type = 2;
    et3.entity_instance_num = 3;
    EXPECT_EQ(false, pldm_is_currect_parent_child(l1, et3));
