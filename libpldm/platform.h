...
/** @brief PLDM pldmNumericSensorStatePresentReading data type
 */
 ...
 *  @param[out] event_class_data - The event class data will be written to this
 *  @param[out] event_class_data_length - length of the event class data
 *  @return pldm_completion_codes
 *  @note  Caller is responsible for memory alloc and dealloc of param
 *         'event_data'
 */
