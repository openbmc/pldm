...
enum pldm_effecter_data_size {
	PLDM_EFFECTER_DATA_SIZE_UINT8 = 0x0,
...
enum pldm_range_field_format {
	PLDM_RANGE_FIELD_FORMAT_UINT8 = 0x0,
 ...
 *  @param[out] effecter_data_size - TThe bit width and format of the setting
 ...
 *  @param[in] instance_id - Message's instance id
 *  @param[in] effecter_id - used to identify and access the effecter
 *  @param[in] effecter_data_size - TThe bit width and format of the setting
 * 				value for the effecter.
 * 				value:{uint8,sint8,uint16,sint16,uint32,sint32}
