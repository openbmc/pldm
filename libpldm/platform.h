 ...
 * @return int    pldm_completion_codes  PLDM_SUCCESS if successful, PLDM_ERROR
 * otherwise
 *
 ...
 * effecter, except those mentioned in the @note below, should be initialized by
 * the caller.
 ...
 */
int encode_pldm_state_effecter_pdr(
 ...
 */
int encode_pldm_sensor_event_data(
