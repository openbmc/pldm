...
/** @brief PLDM PollForPlatformEventMessage response transfer operation flag
 */
enum pldm_poll_for_platform_event_message_transfer_operation_flag {
	PLDM_EVENT_GET_NEXT_PART = 0x00,
	PLDM_EVENT_GET_FIRST_PART = 0x01,
	PLDM_EVENT_ACKNOWLEDGEMENT_ONLY = 0x02
};

/** @brief PLDM PollForPlatformEventMessage response transfer flag
 */
