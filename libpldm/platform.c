				      ...
				      uint8_t *event_data_length)
{
	...
	struct platform_event_message_req *response =
	    (struct platform_event_message_req *)msg->payload;
				       ...
				       struct pldm_msg *msg)
{
	...
	struct platform_event_message_resp *response =
	    (struct platform_event_message_resp *)msg->payload;
	response->completion_code = completion_code;
