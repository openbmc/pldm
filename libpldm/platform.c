	...
	*event_state = response->event_state;
	...
	if (*sensor_data_size == PLDM_EFFECTER_DATA_SIZE_UINT8 ||
		...
		*present_reading = response->present_reading[0];
		...
		uint16_t present_reading_le;
		memcpy(&present_reading_le, response->present_reading,
		       sizeof(uint16_t));
		present_reading_le = le16toh(present_reading_le);
		memcpy(present_reading, &present_reading_le, sizeof(uint16_t));
		...
		uint32_t present_reading_le;
		memcpy(&present_reading_le, response->present_reading,
		       sizeof(uint32_t));
		present_reading_le = le32toh(present_reading_le);
		memcpy(present_reading, &present_reading_le, sizeof(uint32_t));
	}
    ...
    uint8_t *present_reading, struct pldm_msg *msg, size_t payload_length)
{
	...
	if (sensor_data_size == PLDM_EFFECTER_DATA_SIZE_UINT8 ||
		...
		uint16_t present_reading_le;
		memcpy(&present_reading_le, present_reading, sizeof(uint16_t));
		present_reading_le = htole16(present_reading_le);
		memcpy(response->present_reading, &present_reading_le,
		       sizeof(uint16_t));
		...
		uint32_t present_reading_le;
		memcpy(&present_reading_le, present_reading, sizeof(uint32_t));
		present_reading_le = htole32(present_reading_le);
		memcpy(response->present_reading, &present_reading_le,
		       sizeof(uint32_t));
	}
