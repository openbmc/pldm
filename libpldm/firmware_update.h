 ...
 *
 *  Structure representing GetPackageData response
 */
struct pldm_get_package_data_resp {
	uint8_t completion_code;
 ...
 *
 *  Structure representing GetPackageData request
 */
struct pldm_get_package_data_req {
...
/** @struct pldm_get_meta_data_response
 *
 *  Structure representing GetMetaData response
 */
struct pldm_get_meta_data_response {
	uint8_t completion_code;
	uint32_t next_data_transfer_handle;
