 ...
 */
struct pldm_get_types_resp {
	uint8_t completion_code; //!< PLDM GetTypes completion code
 ...
 */
struct pldm_get_commands_resp {
	uint8_t completion_code;  //!< PLDM GetCommands completion code
...
struct pldm_get_version_resp {
	uint8_t completion_code;       //!< PLDM GetVersion completion code
