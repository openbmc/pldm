...
struct pldm_msg {
	...
	uint8_t payload[1];      //!< Address of this will be starting
} __attribute__((packed));       //!< address of pldm payload
 ...
 *  @return pldm_completion_codes
 */
int decode_get_commands_req(const uint8_t *msg, uint8_t *type,
			    ver32_t *version);
