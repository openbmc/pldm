			     ...
			     size_t payload_length)
{
	...
	int dseconds = bcd2dec8(seconds);
	int dminutes = bcd2dec8(minutes);
	int dhours = bcd2dec8(hours);
	int dday = bcd2dec8(day);
	int dmonth = bcd2dec8(month);
	int dyear = bcd2dec16(year);
