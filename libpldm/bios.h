...
#define PLDM_SET_DATE_TIME_REQ_BYTES 7
#define PLDM_SET_DATE_TIME_RESP_BYTES 1
...
/** @struct pldm_set_date_time_resp
 *
 *  Structure representing PLDM set date time response
 */
struct pldm_set_date_time_resp {
	uint8_t completion_code;
	uint32_t next_transfer_handle;
