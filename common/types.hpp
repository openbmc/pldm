...
using FirmwareConditionPathPair = std::pair<FirmwareConditionPath, FirmwareConditionPath>;
using FirmwareTypeCondition = std::pair<FirmwareTypeName, FirmwareConditionPathPair>;
