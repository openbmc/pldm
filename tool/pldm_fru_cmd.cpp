...
class GetFruRecordTableMetadata : public CommandInterface
{
  public:
    ...
    void parseResponseMsg(pldm_msg* responsePtr, size_t payloadLength) override
    {
        ...
        std::cout << "fru_data_major_version: "
                  << static_cast<uint32_t>(fru_data_major_version) << std::endl;
        std::cout << "fru_data_minor_version: "
                  << static_cast<uint32_t>(fru_data_minor_version) << std::endl;
        std::cout << "fru_table_maximum_size: " << fru_table_maximum_size
                  << std::endl;
        std::cout << "fru_table_length: " << fru_table_length << std::endl;
        std::cout << "total_record_set_identifiers: "
                  << total_record_set_identifiers << std::endl;
        std::cout << "total_table_records: " << total_table_records
                  << std::endl;
