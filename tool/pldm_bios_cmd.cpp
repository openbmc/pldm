  ...
  public:
    ...
    void parseResponseMsg(pldm_msg* responsePtr, size_t payloadLength) override
    {
        ...
        std::cout << "DD-MM-YYYY HH:MM:SS - "
                  << static_cast<uint32_t>(bcd2dec8(day));
        std::cout << "-" << static_cast<uint32_t>(bcd2dec8(month));
        std::cout << "-" << bcd2dec16(year) << " ";
        std::cout << static_cast<uint32_t>(bcd2dec8(hours)) << ":";
        std::cout << static_cast<uint32_t>(bcd2dec8(minutes)) << ":";
        std::cout << static_cast<uint32_t>(bcd2dec8(seconds)) << std::endl;
    }
};
