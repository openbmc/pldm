...
class GetBIOSTable : public CommandInterface
{
  public:
    ...
    void parseResponseMsg(pldm_msg* responsePtr, size_t payloadLength) override
    {
        ...
        printBIOSTableMsg(tableData, tableSize, pldmBIOSTableType);
    }
  ...
  private:
    ...
    void decodeStringTable(const void* tableData, size_t tableSize)
    {
        ...
        while (!pldm_bios_table_iter_is_end(iter.get()))
        {
            try
            {
                ...
                std::cout << "String : " << strTableData << std::endl;
            }
    ...
    void printBIOSTableMsg(const void* tableData, size_t tableSize,
