                                 ...
                                 pldm::pdr::StateSetId& stateSetId)
{
    ...
    try
    {
        ...
        if (response.size())
        {
            ...
            {
                auto softoffPdr = reinterpret_cast<pldm_state_effecter_pdr*>(rep.data());
                                ...
                                pldm::pdr::StateSetId& stateSetId)
{
    try
    {
        ...
        {
            auto possibleStates = reinterpret_cast<state_sensor_possible_states*>(possibleStatesStart);
