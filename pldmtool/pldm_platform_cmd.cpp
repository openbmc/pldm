...
void registerCommand(CLI::App& app)
{
    ...
    auto getSensorReading = platform->add_subcommand(
        "GetSensorReading", "get numeric sensor reading");
