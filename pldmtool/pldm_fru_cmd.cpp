...
class FRUTablePrint
{
  ...
  private:
    ...
    static inline const std::map<std::string, const std::map<uint8_t, const char*>> populateMaps{
        {"VINI", IPZVINIRecordTypes},
        {"VSYS", IPZVSYSRecordTypes},
        {"LXR0", IPZLXR0RecordTypes},
        {"VWX10", IPZVW10RecordTypes},
        {"VR10", IPZVR10RecordTypes}};
