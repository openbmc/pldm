  ...
  public:
    ...
    void parseResponseMsg(pldm_msg* responsePtr, size_t payloadLength) override
    {
        ...
        nextPartRequired = accumulateFruPart(
            accumulatedData, fruData.ptr, fruData.length, transferFlag,
...
class GetFruRecordTable : public CommandInterface
{
  public:
    ...
    void parseResponseMsg(pldm_msg* responsePtr, size_t payloadLength) override
    {
        ...
        nextPartRequired = accumulateFruPart(
            accumulatedTable, fru_record_table_data.data(),
            fru_record_table_length, transfer_flag, next_data_transfer_handle,
            dataTransferHandle, operationFlag);
    }
