...
static const std::map<uint8_t, std::string> completionCodesMap{
    ...
    {PLDM_FWUP_INVALID_DATA_TRANSFER_HAND, "INVALID_DATA_TRANSFER_HAND"},
...
{
    if (completionCodesMap.contains(completionCode))
    {
        data["CompletionCode"] = completionCodesMap[completionCode];
    }
    else
    {
