...
void BIOSEnumAttribute::populateValueDisplayNamesMap(
    const std::vector<std::string>& valueDisplayNames, uint16_t attrHandle)
{
    ...
    std::optional<std::variant<int64_t, std::string>> optAttributeValue)
{
    ...
    populateValueDisplayNamesMap(valueDisplayNames, attrHandle);
