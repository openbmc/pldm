    ...
    const BIOSStringTable& stringTable)
{
    ...
    auto [pvHdls, _] = table::attr::decodeEnumEntry(attrEntry);
    auto currHdls = table::attrval::decodeEnumEntry(attrValueEntry);
                                       ...
                                       Table& attrTable, Table& attrValueTable)
{
    ...
    auto attrTableEntry = table::attr::constructEnumEntry(attrTable, &info);
    auto [attrHandle, attrType, _] = table::attr::decodeHeader(attrTableEntry);

    auto currValueIndices = getAttrValue();

    table::attrval::constructEnumEntry(attrValueTable, attrHandle, attrType,
                                       currValueIndices);
}
