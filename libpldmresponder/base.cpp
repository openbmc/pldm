...
static const std::map<Type, Cmd> capabilities{
    ...
    {PLDM_PLATFORM,
     {PLDM_GET_STATE_SENSOR_READINGS, PLDM_SET_NUMERIC_EFFECTER_VALUE,
      PLDM_GET_NUMERIC_EFFECTER_VALUE, PLDM_GET_PDR,
      PLDM_SET_STATE_EFFECTER_STATES, PLDM_PLATFORM_EVENT_MESSAGE}},
    {PLDM_BIOS,
    ...
    {PLDM_FRU,
     {PLDM_GET_FRU_RECORD_TABLE_METADATA, PLDM_GET_FRU_RECORD_TABLE,
      PLDM_SET_FRU_RECORD_TABLE, PLDM_GET_FRU_RECORD_BY_OPTION}},
#ifdef OEM_IBM
    {PLDM_OEM,
