        ...
        const std::vector<set_effecter_state_field>& stateField)
    {
        ...
        try
        {
                 ...
                 ++currState)
            {
                ...
                {
                    error(
                        "Invalid state set value for '{EFFECTERID}', '{EFFECTER_STATE}', '{COMPOSITE_EFFECTER_ID}', '{PATH}'.",
                ...
                if (stateField[currState].set_request == PLDM_REQUEST_SET)
                {
                    ...
                    {
                        error(
                            "Error setting '{PROPERTY}' of '{INTERFACE}' at '{PATH}' - '{ERROR}'",
        ...
        {
            error("The '{EFFECTERID}' does not exist - '{ERROR}'.",
