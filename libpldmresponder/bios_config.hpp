...
using CurrentValue = std::variant<uint64_t, std::string>;
using DefaultValue = std::variant<uint64_t, std::string>;
using OptionString = uint8_t;
using OptionValue = std::variant<uint64_t, std::string>;
