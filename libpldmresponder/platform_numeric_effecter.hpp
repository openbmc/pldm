 ...
 *  @tparam[out] value - The new raw value.
 *
 *  @return - Success or failure
 */
template <typename T>
int getEffecterRawValue(const pldm_numeric_effecter_value_pdr* pdr,
                        T& effecterValue, PropertyValue& value)
{
    // X = Round [ (Y - B) / m ]
    ...
    switch (pdr->effecter_data_size)
    {
        case PLDM_EFFECTER_DATA_SIZE_UINT8:
        {
            ...
            if ((pdr->min_set_table.value_u8 != 0 &&
                 pdr->max_set_table.value_u8 != 0) &&
        ...
        case PLDM_EFFECTER_DATA_SIZE_SINT8:
        {
            auto rawValue = static_cast<int8_t>(
                round(effecterValue - pdr->offset) / pdr->resolution);
            if ((pdr->min_set_table.value_s8 != 0 &&
                 pdr->max_set_table.value_s8 != 0) &&
            ...
            {
                value = static_cast<int8_t>(rawValue);
            }
        ...
        case PLDM_EFFECTER_DATA_SIZE_UINT16:
        {
            auto rawValue = static_cast<uint16_t>(
                round(effecterValue - pdr->offset) / pdr->resolution);
            if ((pdr->min_set_table.value_u16 != 0 &&
                 pdr->max_set_table.value_u16 != 0) &&
        ...
        case PLDM_EFFECTER_DATA_SIZE_SINT16:
        {
            auto rawValue = static_cast<int16_t>(
                round(effecterValue - pdr->offset) / pdr->resolution);
            if ((pdr->min_set_table.value_s16 != 0 &&
                 pdr->max_set_table.value_s16 != 0) &&
        ...
        case PLDM_EFFECTER_DATA_SIZE_UINT32:
        {
            auto rawValue = static_cast<uint32_t>(
                round(effecterValue - pdr->offset) / pdr->resolution);
            if ((pdr->min_set_table.value_u32 != 0 &&
                 pdr->max_set_table.value_u32 != 0) &&
        ...
        case PLDM_EFFECTER_DATA_SIZE_SINT32:
        {
            auto rawValue = static_cast<int32_t>(
                round(effecterValue - pdr->offset) / pdr->resolution);
            if ((pdr->min_set_table.value_s32 != 0 &&
                 pdr->max_set_table.value_s32 != 0) &&
                       ...
                       uint8_t effecterDataSize, uint8_t* effecterValue)
{
    ...
    switch (effecterDataSize)
    {
        case PLDM_EFFECTER_DATA_SIZE_UINT8:
        {
            ...
            rc = getEffecterRawValue<uint8_t>(pdr, currentValue, value);
        ...
        case PLDM_EFFECTER_DATA_SIZE_SINT8:
        {
            ...
            rc = getEffecterRawValue<int8_t>(pdr, currentValue, value);
        ...
        case PLDM_EFFECTER_DATA_SIZE_UINT16:
        {
            ...
            rc = getEffecterRawValue<uint16_t>(pdr, currentValue, value);
        ...
        case PLDM_EFFECTER_DATA_SIZE_SINT16:
        {
            ...
            rc = getEffecterRawValue<int16_t>(pdr, currentValue, value);
        ...
        case PLDM_EFFECTER_DATA_SIZE_UINT32:
        {
            ...
            rc = getEffecterRawValue<uint32_t>(pdr, currentValue, value);
        ...
        case PLDM_EFFECTER_DATA_SIZE_SINT32:
        {
            ...
            rc = getEffecterRawValue<int32_t>(pdr, currentValue, value);
