 ...
 *  @tparam[in] minSettable - The minimum legal setting value that the effecter
 *                         accepts.
 *  @tparam[in] maxSettable - The maximum legal setting value that the effecter
 *                         accepts.
 ...
 */
template <typename T>
int convertToRawValue(const pldm_numeric_effecter_value_pdr* pdr, T minSettable,
                      T maxSettable, T& value)
{
    ...
    if ((maxSettable > minSettable) &&
        (value < minSettable || value > maxSettable))
    {
                       ...
                       uint8_t* effecterValue)
{
    ...
    switch (pdr->effecter_data_size)
    {
        case PLDM_EFFECTER_DATA_SIZE_UINT8:
        {
            ...
            rc = convertToRawValue<uint8_t>(pdr, pdr->min_set_table.value_u8,
        ...
        case PLDM_EFFECTER_DATA_SIZE_SINT8:
        {
            ...
            rc = convertToRawValue<int8_t>(pdr, pdr->min_set_table.value_s8,
        ...
        case PLDM_EFFECTER_DATA_SIZE_UINT16:
        {
            ...
            rc = convertToRawValue<uint16_t>(pdr, pdr->min_set_table.value_u16,
        ...
        case PLDM_EFFECTER_DATA_SIZE_SINT16:
        {
            ...
            rc = convertToRawValue<int16_t>(pdr, pdr->min_set_table.value_s16,
        ...
        case PLDM_EFFECTER_DATA_SIZE_UINT32:
        {
            ...
            rc = convertToRawValue<uint32_t>(pdr, pdr->min_set_table.value_u32,
        ...
        case PLDM_EFFECTER_DATA_SIZE_SINT32:
        {
            ...
            rc = convertToRawValue<int32_t>(pdr, pdr->min_set_table.value_s32,
