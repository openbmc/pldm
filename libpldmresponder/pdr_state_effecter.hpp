...
void generateStateEffecterHandler(Handler& handler, const Json& json,
                                  pdr_utils::RepoInterface& repo)
{
    ...
    for (const auto& e : entries)
    {
        ...
        pdr_utils::DbusValMaps dbusValMaps{};
        uint8_t* start =
        ...
        for (const auto& effecter : effecters)
        {
            ...
            pdr_utils::DbusIdToValMap dbusIdToValMap =
        ...
        handler.addDbusValMaps(pdr->effecter_id, std::move(dbusValMaps));
        PdrEntry pdrEntry{};
