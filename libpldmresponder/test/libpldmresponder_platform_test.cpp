...
TEST(getPDR, testGoodPath)
{
    ...
    struct pldm_get_pdr_req* request = reinterpret_cast<pldm_get_pdr_req*>(req->payload);
    ...
    struct pldm_get_pdr_resp* resp = reinterpret_cast<pldm_get_pdr_resp*>(responsePtr->payload);
...
TEST(getPDR, testFindPDR)
{
    ...
    while (!found)
    {
        ...
        {
            pldm_state_effecter_pdr* pdr = reinterpret_cast<pldm_state_effecter_pdr*>(resp->record_data);
...
TEST(setStateEffecterStatesHandler, testGoodRequest)
{
    ...
    pldm_state_effecter_pdr* pdr = reinterpret_cast<pldm_state_effecter_pdr*>(e.data);
...
TEST(setNumericEffecterValueHandler, testGoodRequest)
{
    ...
    pldm_numeric_effecter_value_pdr* pdr = reinterpret_cast<pldm_numeric_effecter_value_pdr*>(e.data);
...
TEST(getNumericEffecterValueHandler, testGoodRequest)
{
    ...
    struct pldm_get_numeric_effecter_value_resp* resp =
        reinterpret_cast<pldm_get_numeric_effecter_value_resp*>(responsePtr->payload);
    ASSERT_EQ(PLDM_SUCCESS, resp->completion_code);
...
TEST(getStateSensorReadingsHandler, testGoodRequest)
{
    ...
    ASSERT_NE(record, nullptr);
    pldm_state_sensor_pdr* pdr = reinterpret_cast<pldm_state_sensor_pdr*>(e.data);
