...
class RepoInterface
{
  public:
     ...
     *  @param[in] parentEntity - pointer to the parent entity.
     *  @param[in] type - relation with the parent : logical(0) or physical(1)
     *
     */
    virtual void addToEntityAssociationTree(pldm_entity* entity,
...
class Repo : public RepoInterface
{
  public:
    ...
    void addToEntityAssociationTree(pldm_entity* entity,
                                    pldm_entity* parentEntity,
