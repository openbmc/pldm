                                    ...
                                    const std::string& path)
{
    ...
    {
        std::cout << "Inside updateAssociationTree: objects=\n"; // << it->first << " " << it->second.first << " " << it->second.second << "\n";
        std::cout << elem.first.str() << " " << elem.second.first << " " << elem.second.second << "\n";
    }*/
    std::cout << "Inside updateAssociationTree: path=" << path << std::endl;
