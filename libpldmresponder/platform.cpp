                                          ...
                                          size_t payloadLength)
{
    ...
    if (isOemNumericEffecter(*this, effecterId, entityType, entityInstance,
                             ...
                             effecterOffset,
                             effecterResolution /*containerId*/) &&
        oemPlatformHandler != nullptr)
    {
        rc = oemPlatformHandler->oemSetNumericEffecterValueHandler(
            entityType, entityInstance, effecterSemanticId,
            /*containerId,*/ effecterDataSize, effecterValue, effecterOffset,
            effecterResolution, effecterId);
    }
    else
    {
...
bool isOemNumericEffecter(
    ...
    real32_t& effecterResolution /*, uint16_t& containerId*/)
{
