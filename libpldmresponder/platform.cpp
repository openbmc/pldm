                                         ...
                                         size_t payloadLength)
{
    ...
    if (isOemStateEffecter(*this, effecterId, entityType, entityInstance,
                           stateSetId))
    {
                                         ...
                                         size_t payloadLength)
{
    ...
    if (isOemStateSensor(*this, sensorId, entityType, entityInstance,
                         stateSetId))
    {
        rc = oemPlatformHandler->getOemStateSensorReadingsHandler(
            sensorId, sensorRearmCout, entityType, entityInstance, stateSetId,
            comSensorCnt, stateField);
    }
    else
    {
...
bool isOemStateSensor(Handler& handler, uint16_t sensorId, uint16_t& entityType,
