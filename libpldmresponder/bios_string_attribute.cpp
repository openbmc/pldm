    ...
    BIOSAttribute(entry, dbusHandler)
{
    ...
    stringInfo.stringType = iter->second;
    ...
    const pldm_bios_attr_table_entry*, const BIOSStringTable&)
{
    ...
    PropertyValue value = table::attrval::decodeStringEntry(attrValueEntry);
                                         ...
                                         Table& attrValueTable)
{
    ...
    auto attrTableEntry = table::attr::constructStringEntry(attrTable, &info);
    auto [attrHandle, attrType, _] = table::attr::decodeHeader(attrTableEntry);
    auto currStr = getAttrValue();
    table::attrval::constructStringEntry(attrValueTable, attrHandle, attrType,
                                         currStr);
}
