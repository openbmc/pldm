...
class FruImpl
{
  public:
    ...
    std::vector<uint32_t> setStatePDRParams(const std::string& pdrJsonsDir, uint16_t nextSensorId,
                           uint16_t nextEffecterId,
                           pldm::responder::pdr_utils::DbusObjMaps& sensorDbusObjMaps,
                           pldm::responder::pdr_utils::DbusObjMaps& effecterDbusObjMaps,
                           bool hotPlug,const Json& json, const std::string& fruObjectPath="", pldm::responder::pdr_utils::Type pdrType=0);
  private:
    uint16_t nextRSI()
    {
        return ++rsi;
...
class Handler : public CmdHandler
{
  ...
  public:
    ...
    void setStatePDRParams(const std::string& pdrJsonsDir, uint16_t nextSensorId,
                           uint16_t nextEffecterId,
                           pldm::responder::pdr_utils::DbusObjMaps& sensorDbusObjMaps,
                           pldm::responder::pdr_utils::DbusObjMaps& effecterDbusObjMaps,
                           bool hotPlug);
