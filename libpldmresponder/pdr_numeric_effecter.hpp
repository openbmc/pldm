                                ...
                                pdr_utils::RepoInterface& repo)
{
    ...
    for (const auto& e : entries)
    {
        ...
        pdr->aux_unit_modifier = static_cast<int8_t>(e.value("aux_unit_modifier", 0));
        ...
        pdr->resolution = static_cast<real32_t>(e.value("effecter_resolution_init", 1.00));
        ...
        pdr->transition_interval = static_cast<real32_t>(e.value("transition_interval", 0.00));
        switch (pdr->effecter_data_size)
        {
            ...
            case PLDM_EFFECTER_DATA_SIZE_SINT8:
                pdr->max_settable.value_s8 = static_cast<int8_t>(e.value("max_settable", 0));
                pdr->min_settable.value_s8 = static_cast<int8_t>(e.value("min_settable", 0));
                break;
            ...
            case PLDM_EFFECTER_DATA_SIZE_SINT16:
                pdr->max_settable.value_s16 = static_cast<int16_t>(e.value("max_settable", 0));
                pdr->min_settable.value_s16 = static_cast<int16_t>(e.value("min_settable", 0));
                break;
            ...
            case PLDM_EFFECTER_DATA_SIZE_SINT32:
                pdr->max_settable.value_s32 = static_cast<int32_t>(e.value("max_settable", 0));
                pdr->min_settable.value_s32 = static_cast<int32_t>(e.value("min_settable", 0));
                break;
            default:
                break;
        }
        ...
        switch (pdr->range_field_format)
        {
            ...
            case PLDM_RANGE_FIELD_FORMAT_SINT8:
                pdr->nominal_value.value_s8 = static_cast<int8_t>(e.value("nominal_value", 0));
                pdr->normal_max.value_s8 = static_cast<int8_t>(e.value("normal_max", 0));
                pdr->normal_min.value_s8 = static_cast<int8_t>(e.value("normal_min", 0));
                pdr->rated_max.value_s8 = static_cast<int8_t>(e.value("rated_max", 0));
                pdr->rated_min.value_s8 = static_cast<int8_t>(e.value("rated_min", 0));
                break;
            ...
            case PLDM_RANGE_FIELD_FORMAT_SINT16:
                pdr->nominal_value.value_s16 = static_cast<int16_t>(e.value("nominal_value", 0));
                pdr->normal_max.value_s16 = static_cast<int16_t>(e.value("normal_max", 0));
                pdr->normal_min.value_s16 = static_cast<int16_t>(e.value("normal_min", 0));
                pdr->rated_max.value_s16 = static_cast<int16_t>(e.value("rated_max", 0));
                pdr->rated_min.value_s16 = static_cast<int16_t>(e.value("rated_min", 0));
                break;
            ...
            case PLDM_RANGE_FIELD_FORMAT_SINT32:
                pdr->nominal_value.value_s32 = static_cast<int32_t>(e.value("nominal_value", 0));
                pdr->normal_max.value_s32 = static_cast<int32_t>(e.value("normal_max", 0));
                pdr->normal_min.value_s32 = static_cast<int32_t>(e.value("normal_min", 0));
                pdr->rated_max.value_s32 = static_cast<int32_t>(e.value("rated_max", 0));
                pdr->rated_min.value_s32 = static_cast<int32_t>(e.value("rated_min", 0));
                break;
            case PLDM_RANGE_FIELD_FORMAT_REAL32:
                pdr->nominal_value.value_f32 = static_cast<real32_t>(e.value("nominal_value", 0));
                pdr->normal_max.value_f32 = static_cast<real32_t>(e.value("normal_max", 0));
                pdr->normal_min.value_f32 = static_cast<real32_t>(e.value("normal_min", 0));
                pdr->rated_max.value_f32 = static_cast<real32_t>(e.value("rated_max", 0));
                pdr->rated_min.value_f32 = static_cast<real32_t>(e.value("rated_min", 0));
                break;
            default:
                break;
        }
