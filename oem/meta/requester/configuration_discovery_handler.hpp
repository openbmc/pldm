...
class ConfigurationDiscoveryHandler : public MctpDiscoveryHandlerIntf
{
  public:
     ...
     */
    std::map<eid, MctpEndpoint>& getConfigurations(void)
    {
  ...
  private:
     ...
     */
    void appendIfEidMatch([[maybe_unused]] uint8_t targetEid,
                          [[maybe_unused]] const std::string& configPath,
                          [[maybe_unused]] const MctpEndpoint& endpoint)
    {}
     ...
     * information.
     */
    std::map<eid, MctpEndpoint> configurations;
