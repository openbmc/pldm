    ...
    uint8_t tid, size_t eventDataOffset)
{
    ...
    processOemMetaEvent(tid, eventData, eventDataSize, configurations);
...
void OemEventManager::getCommonDimmLocation(const dimm_info& dimmInfo,
        ...
        configurations) const
{
    ...
    static constexpr auto memoryCxlEvent =
        std::to_array({"DIMM A0", "DIMM B0", "DIMM A1", "DIMM B1", "Reserved"});
                    ...
                    switch (eventType)
                    {
                        ...
                        case MemoryEvent::MEM_CXL_POST_PPR:
                        {
                            errorLog +=
                                ...
                                memoryEvent[static_cast<uint8_t>(eventType)] +
                                ", " +
                                memoryPprEvent[eventData[11] >> 7 & 0x1] +
