    ...
    uint8_t generalInfo) const
{
    ...
    switch (eventType)
    {
        ...
        case MemoryError::MEMORY_CXL_MEM_SPD_CRC_ERR:
        {
            errorLog +=
                "GeneralInfo: MEMORY_CXL_MEM_SPD_CRC_ERR(0x" +
                to_hex_string(generalInfo) + "), " + dimmLocation +
                ", DIMM Failure Event: " +
                memoryError[static_cast<uint8_t>(eventType)] + ", " +
                getDimmDeviceName(eventData, 7) +
        ...
        case MemoryError::MEMORY_CXL_MEM_SPD_NULL_DATA_ERR:
        {
            errorLog +=
                "GeneralInfo: MEMORY_CXL_MEM_SPD_NULL_DATA_ERR(0x" +
                to_hex_string(generalInfo) + "), " + dimmLocation +
                ", DIMM Failure Event: " +
                memoryError[static_cast<uint8_t>(eventType)] + ", " +
                getDimmDeviceName(eventData, 7) +
        ...
        case MemoryError::MEMORY_CXL_MEM_INIT_TIMEOUT_ERR:
        {
            errorLog +=
                "GeneralInfo: MEMORY_CXL_MEM_INIT_TIMEOUT_ERR(0x" +
                to_hex_string(generalInfo) + "), " + dimmLocation +
                ", DIMM Failure Event: " +
                memoryError[static_cast<uint8_t>(eventType)] + ", " +
                getDimmDeviceName(eventData, 7) +
