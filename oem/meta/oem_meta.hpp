...
class OemMETA
{
  ...
  public:
    ...
    explicit OemMETA(const pldm::utils::DBusHandler* dbusHandler,
        ...
        dbusHandler(dbusHandler), mctp_eid(mctp_eid), invoker(invoker),
        platformManager(platformManager)
    {
        configurationDiscovery =
            std::make_shared<pldm::requester::ConfigurationDiscoveryHandler>(dbusHandler);
        ...
        oemEventManager = std::make_shared<oem_meta::OemEventManager>(
            configurationDiscovery, platformManager);
