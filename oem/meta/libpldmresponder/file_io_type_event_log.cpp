...
static void platformEvent([[maybe_unused]] const message& eventData,
...
static const std::map<EventType, EventDescriptor> eventHandlers = {
    ...
    {EventType::CXL1_HB, {nullptr, report::cxlEvent}},
    {EventType::CXL2_HB, {nullptr, report::cxlEvent}},
    {EventType::PLTRST_ASSERTION, {nullptr, report::platformEvent}},
    {EventType::POST_STARTED, {nullptr, report::platformEvent}},
    {EventType::POST_ENDED, {nullptr, report::platformEvent}},
