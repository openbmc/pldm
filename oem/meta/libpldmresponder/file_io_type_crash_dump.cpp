...
int CrashDumpHandler::handleCxlCrashdump(std::span<const uint8_t> data)
{
    ...
    std::string slotNum = getSlotNumberStringByTID(configurations, tid);
    ...
    switch (crdCxlCode)
    {
        ...
        case CrdCxlCode::crashDumpEnd:
        {
            ...
            auto prefix = "host" + slotNum + "_crashdump_";
            ...
            auto error = "CXL Crashdump for Host: " + slotNum +
                                     ...
                                     std::stringstream& ss)
{
    ...
    switch (static_cast<CrdCtrl>(data[0]))
    {
        ...
        case CrdCtrl::finish:
        {
            ...
            ss.clear();
            auto filePath = dumpDir / filename;
            auto error = "Crashdump for Host: " + slotNum +
                         " is generated at " + filePath.string();
            pldm::utils::reportError(error.c_str());
            break;
        }
