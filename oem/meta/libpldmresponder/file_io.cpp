    ...
    [[maybe_unused]] pldm_tid_t messageTid, FileIOType fileIOType)
{
    switch (fileIOType)
    {
        ...
        case FileIOType::BOOT_ORDER:
            return std::make_unique<BootOrderHandler>(messageTid, dBusHandler);
        default:
