...
{
  public:
    FileIOHandler(std::shared_ptr<pldm::ConfigurationDiscoveryHandler> configurationDescovery) :
  ...
  private:
    ...
    std::unique_ptr<FileHandler>
		...
		std::shared_ptr<pldm::ConfigurationDiscoveryHandler> configurationDescovery;
};
