...
{
  public:
    FileIOHandler(std::shared_ptr<pldm::requester::ConfigurationDiscoveryHandler>
                      configurationDescovery) :
  ...
  private:
    ...
    std::shared_ptr<pldm::requester::ConfigurationDiscoveryHandler> configurationDescovery;
};
