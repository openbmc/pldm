                ...
                case UnifiedError::UNIFIED_PCIE_ERR:
                {
                    ...
                    { // x86
                        errorLog =
                            ...
                            ", ErrID2: 0x" + to_hex_string(eventData[12]) +
                            ", ErrID1: 0x" + to_hex_string(eventData[13]);
                    }
                    else
                    {
                        ...
                        case MemoryError::MEMORY_PMIC_ERR:
                        {
                            ...
                            { // AMD
                                errorLog =
                                    ...
                                    ", Major Code: 0x" + to_hex_string(eventData[11]) +
                                    ", Minor Code: 0x" +
                                    to_hex_string((eventData[13] << 8) | eventData[12]);
                            }
                            break;
                        }
                        default:
                    ...
                    switch (eventType)
                    {
                        case PcieEvent::PCIE_DPC:
                        {
                            errorLog =
                                ...
                                ", Status: 0x" +
                                to_hex_string((eventData[9] << 8) | eventData[8]) +
                                ", Source ID: 0x" +
                                to_hex_string((eventData[11] << 8) | eventData[10]);
                            break;
                        }
                        default:
                        {
