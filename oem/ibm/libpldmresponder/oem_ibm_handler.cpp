...
void pldm::responder::oem_ibm_platform::Handler::turnOffRealSAIEffecter()
{
    ...
    {
        error("Failed to turn off partition SAI effecter due to the "
              "error {ERR_EXCEP}",
              "ERR_EXCEP", e.what());
    }
    try
    ...
    {
        error("Failed to turn off platform SAI effecter due to the "
              "error {ERR_EXCEP}",
              "ERR_EXCEP", e.what());
    }
}
...
uint8_t pldm::responder::oem_ibm_platform::Handler::fetchRealSAIStatus()
{
    ...
    {
        error("Failed to fetch Real SAI sensor status due to the "
              "error {ERR_EXCEP}",
              "ERR_EXCEP", e.what());
    }
