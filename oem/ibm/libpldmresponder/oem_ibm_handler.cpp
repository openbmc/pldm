...
void pldm::responder::oem_ibm_platform::Handler::turnOffRealSAIEffecter()
{
    try
    {
        pldm::utils::DBusMapping dbusMapping{
            ...
            "Functional", "bool"};
        pldm::utils::DBusHandler().setDbusProperty(dbusMapping, true);
    }
    catch (const std::exception& e)
    {
...
bool pldm::responder::oem_ibm_platform::Handler::fetchRealSAIStatus()
{
    ...
    bool isPartitionSAIOn = false;
    bool isPlatformSAIOn = false;
    bool realSAIStatus = false;
    ...
    try
    {
        ...
        realSAIStatus = (isPartitionSAIOn || isPlatformSAIOn);
    }
    catch (const std::exception& e)
    {
