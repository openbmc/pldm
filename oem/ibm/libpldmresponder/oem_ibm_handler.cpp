        ...
        const pldm_pdr* repo)
{
    ...
    record = pldm_pdr_find_last_in_range(repo, BMC_PDR_START_RANGE, BMC_PDR_END_RANGE);
    return record;
}
...
{
    return record_handle >= HOST_PDR_START_RANGE && record_handle <= HOST_PDR_END_RANGE;
}
