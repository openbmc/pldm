                                   ...
                                   size_t payloadLength)
{
    ...
    log<level::ERR>("Calling setHandler");
    std::cout << "Calling setHandler with dma address " << address << std::endl;
    ...
    log<level::ERR>("Calling setHandler success");
    encode_rw_file_type_memory_resp(request->hdr.instance_id,
