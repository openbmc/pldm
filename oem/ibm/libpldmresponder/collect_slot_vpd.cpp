    ...
    uint8_t stateFiledvalue, const pldm_entity& entity)
{
    ...
    {
	(stateFiledvalue == uint8_t(PLDM_OEM_IBM_PCIE_SLOT_EFFECTER_REPLACE) ? uint8_t(PLDM_OEM_IBM_PCIE_SLOT_SENSOR_STATE_UNKOWN) : uint8_t(PLDM_OEM_IBM_PCIE_SLOT_SENSOR_STATE_DISABLED); 
    }
