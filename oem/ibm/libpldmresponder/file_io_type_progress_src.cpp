...
int ProgressCodeHandler::setRawBootProperty(const std::vector<uint8_t>& progressCodeBuffer)
{
    ...
    try
    {
        auto service = pldm::utils::DBusHandler().getService(RawObjectPath, RawInterface);
