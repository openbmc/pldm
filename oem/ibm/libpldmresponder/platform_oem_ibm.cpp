    ...
    pldm::requester::Handler<pldm::requester::Request>* handler)
{
    ...
    {
        error(
            "Error in getting current remote pldm terminus state, error - '{ERROR}' Continue sending the bios attribute update event ...",
            "ERROR", e);
    }
    ...
    {
        error(
            "BIOS Attribute update event message encode failed with response code '{RC}'",
            "RC", lg2::hex, rc);
