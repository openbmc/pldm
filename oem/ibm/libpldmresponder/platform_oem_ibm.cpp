    ...
    pldm::requester::Handler<pldm::requester::Request>* handler)
{
    ...
    {
        error(
            "Error in getting current host state, error - '{ERROR}' Continue sending the bios attribute update event ...",
            "ERROR", e);
    }
    ...
    {
        error(
            "BIOS Attribute update event message encode failure, with response code '{RC}'",
            "RC", lg2::hex, rc);
    ...
    auto platformEventMessageResponseHandler =
        ...
        {
            error(
                "Failed to decode BIOS Attribute update platform_event_message_resp, with response code '{RC}' and completion code '{CC}'",
