...
void PCIeInfoHandler::parseTopologyData()
{
    ...
    // The endianness handling needs to occur at the layer that can first
    // interpret the data.
    //  The DMA engine has no idea of the structure of the data its copying its
    //  up to the user of the data to deal with the endianness once it has been
    //  copied For topology support, Remote PLDM termius is considered as big
    //  endian. So the big endian conversion is made before using the data
