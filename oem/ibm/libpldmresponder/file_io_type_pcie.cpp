...
void PCIeInfoHandler::parseTopologyData()
{
    ...
    // For topology support, Remote PLDM termius is considered as big endian.
    // mmap will map the file byte to byte.
    // So the big endian conversion is made before using the data
