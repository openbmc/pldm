                                  ...
                                  uint64_t address)
{
    ...
    if (upstream)
    {
        ...
        {
            error(
                "FileHandler_transferFileData_Offset exceeds file size, OFFSET={OFFSET} FILE_SIZE={FILE_SIZE}, FILE_HANDLE={FILE_HANDLE}",
                          ...
                          uint32_t& length, Response& response)
{
    ...
    {
        error(
            "FileHandler_readFile_Offset exceeds file size, OFFSET={OFFSET} FILE_SIZE={FILE_SIZE} FILE_HANDLE={File_Handle}",
