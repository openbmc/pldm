                         ...
                         oem_platform::Handler* /*oemPlatformHandler*/)
{
    ...
    try
    {
        keywrdStr = pldm::utils::DBusHandler().getDbusProperty<std::string>(keywrdObjPath, keywrdPropName, keywrdInterface);
    }
    ...
    if (!fs::exists(keywrdDirPath))
    {
        ...
        fs::permissions(keywrdDirPath, fs::perms::others_read | fs::perms::owner_write);
    }
