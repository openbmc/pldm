 ...
 */
std::filesystem::path
    pldm::responder::oem_ibm_system_config::Handler::getPlatformName()
{
    if (!systemType.empty())
    {
 ...
 */
void pldm::responder::oem_ibm_system_config::Handler::
    ibmCompatibleAddedCallback(sdbusplus::message::message& msg)
{
