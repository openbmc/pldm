...
int LicenseHandler::fileAckWithMetaData(uint32_t metaDataValue)
{
    ...
    if (metaDataValue == status::InvalidLicense)
    {
    ...
    else if (metaDataValue == status::Activated)
    {
        PropertyValue valueStatus{
    ...
    else if (metaDataValue == status::Pending)
    {
        PropertyValue valueStatus{
    ...
    else if (metaDataValue == status::ActivationFailed)
    {
        PropertyValue valueStatus{
    ...
    else if (metaDataValue == status::IncorrectSystem)
    {
        PropertyValue valueStatus{
    ...
    else if (metaDataValue == status::InvalidHostState)
    {
        PropertyValue valueStatus{
    ...
    else if (metaDataValue == status::IncorrectSequence)
    {
        PropertyValue valueStatus{
