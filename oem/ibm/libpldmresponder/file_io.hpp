...
class Handler : public CmdHandler
{
  public:
        ...
        dbusImplReqester(dbusImplReqester)
    {
        ...
        respHandlers.emplace(PLDM_NEW_FILE_AVAILABLE,
                         [this](const pldm_msg* request, size_t payloadLength) {
                             return this->newFileAvailableResp(request,
                                                           payloadLength);
                         });
     ...
     *   @return PLDM response message
     */
    Response newFileAvailableResp(const pldm_msg* request, size_t payloadLength);
