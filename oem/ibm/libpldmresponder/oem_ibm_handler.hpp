...
class Handler : public oem_platform::Handler
{
  public:
     ...
     */
    void modifyPDROemActions(uint16_t entityType, uint16_t stateSetId) override;
  ...
  private:
    ...
    /** @brief pointer to BMC's primary PDR repo, used to look up the state
     *  effecter PDRs backing the OEM actions
     */
