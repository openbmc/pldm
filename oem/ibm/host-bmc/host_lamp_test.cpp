...
bool HostLampTest::asserted(bool value)
{
    ...
    if (value)
    {
        ...
        // Call setHostStateEffecter mthod to notify PHYP to start lamp test.
        // If user set Asserted to true again, need to notify PHYP to start lamp
        // test again.
