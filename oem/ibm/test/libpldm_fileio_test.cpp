...
TEST(ReadWriteFileTypeMemory, testGoodEncodeRequest)
{
    ...
    auto rc = encode_rw_file_type_memory_req(
...
TEST(ReadWriteFileTypeMemory, testGoodEncodeResponse)
{
    ...
    auto rc =
        encode_rw_file_type_memory_resp(0, PLDM_READ_FILE_BY_TYPE_INTO_MEMORY,
...
TEST(ReadWriteFileTypeMemory, testBadEncodeResponse)
{
    ...
    rc = encode_rw_file_type_memory_resp(0, PLDM_READ_FILE_BY_TYPE_INTO_MEMORY,
