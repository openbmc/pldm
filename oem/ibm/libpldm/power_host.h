#ifndef OEM_IBM_POWER_HOST_H
#define OEM_IBM_POWER_HOST_H
...
enum pldm_power_host_commands {
	PLDM_GET_ALERT_STATUS = 0xF0 // Custom oem cmd
};

/** @brief PLDM Command specific codes
 */
enum pldm_power_host_completion_codes { UNSUPPORTED_FORMAT_VERSION = 0x81 };
