...
enum pldm_fileio_file_type {
	...
	PLDM_FILE_TYPE_UNDEFINED = 0xFFFF,
};

enum pldm_fileio_resdump_status_codes {
	PLDM_RES_DUMP_SECURITY_VALIDATED_SUCCESS = 0,
	PLDM_RES_DUMP_ACF_FILE_INVALID = 1,
	PLDM_RES_DUMP_PWD_INVALID = 2,
	PLDM_RES_DUMP_PERMISSION_DENIED = 3,
	PLDM_RES_DUMP_RESOURCE_SELECTOR_INVALID = 4,
};

enum pldm_fileio_res_selector_invalid_status_codes {
	PLDM_RES_SELEC_INVALID_PARAM_LENGTH = 0x00000001,
	PLDM_RES_SELEC_UNKWN_PARAM_VERSION = 0x00000002,
	PLDM_RES_SELEC_UNKWN_CLIENT_TYPE = 0x00000004,
	PLDM_RES_SELEC_INVALID_CMND_STRING = 0x00000005,
	PLDM_RES_SELEC_INVALID_STATE = 0x00000006,
	PLDM_RES_SELEC_BUSY = 0x00000007,
	PLDM_RES_SELEC_UNKWN_DUMP = 0x00000008,
	PLDM_RES_SELEC_INVALID_OFFSET = 0x00000009,
	PLDM_RES_SELEC_EOF_REACHED = 0x00000010,
	PLDM_RES_SELEC_KEY_UNUSED = 0xFFFFFFFF,
};

enum pldm_fileio_cod_license_key_status_codes {
	PLDM_COD_LICENSE_KEY_INSTALL_SUCCESS = 0x00000000,
	PLDM_COD_LICENSE_KEY_INVALID_LICENSE = 0x00000001,
	PLDM_COD_LICENSE_KEY_INVALID_SYSTEM = 0x00000002,
	PLDM_COD_LICENSE_KEY_INVALID_SEQUENCE = 0x00000003,
	PLDM_COD_LICENSE_KEY_UNUSED = 0xFFFFFFFF,
};
...
struct pldm_file_ack_with_meta_data_req {
	...
	uint32_t file_handle;	   //!< Handle to file
	uint8_t file_status;	   //!< Status of file processing
	uint32_t file_meta_data_1; //!< meta data specific to file type
	uint32_t file_meta_data_2; //!< meta data specific to file type
	uint32_t file_meta_data_3; //!< meta data specific to file type
	uint32_t file_meta_data_4; //!< meta data specific to file type
} __attribute__((packed));
 ...
 *  @param[in] file_handle - A handle to the file
 *  @param[in] file_status - Status of file processing
 *  @param[in] file_meta_data_1 - File type specific meta data
 *  @param[in] file_meta_data_2 - File type specific meta data
 *  @param[in] file_meta_data_3 - File type specific meta data
 *  @param[in] file_meta_data_4 - File type specific meta data
 *  @param[out] msg - Message will be written to this
 *  @return pldm_completion_codes
 */
