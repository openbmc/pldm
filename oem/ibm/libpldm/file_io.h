 ...
 *  @return pldm_completion_codes
 *  @note  Caller is responsible for memory alloc and dealloc of param 'msg'
 *  Although read file response command includes file data, this function
 *  does not include the same as an input argument to prevent copying data
 *  multiple times. The position of file data is calculated by caller from
 *  address and size of other input arguments.
 */
 ...
 *  @return pldm_completion_codes
 *  @note  Caller is responsible for memory alloc and dealloc of param 'msg'
 *  Although write file request command includes file data, this function
 *  does not include the same as an input argument to prevent copying data
 *  multiple times. The position of file data is calculated by caller from
 *  address and size of other input arguments.
 */
