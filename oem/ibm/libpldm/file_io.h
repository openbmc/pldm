 ...
 *                       requester asked for.
 *  @return pldm_completion_codes or file offset at which the read should begin
 */
uint32_t decode_read_file_resp(const uint8_t *msg, size_t payload_length,
			       uint8_t *completion_code, uint32_t *length);
 ...
 *  @return pldm_completion_codes or file offset at which the write should begin
 */
uint32_t decode_write_file_req(const uint8_t *msg, size_t payload_length,
