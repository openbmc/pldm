...
// read file response bytes without file data size which is variable
#define PLDM_CONST_READ_FILE_RESP_BYTES 5
// write file request bytes without file data size which is variable
#define PLDM_CONST_WRITE_FILE_REQ_BYTES 12
#define PLDM_WRITE_FILE_RESP_BYTES 5
#define PLDM_MAX_FILE_SIZE 1024
...
struct pldm_write_file_req {
	...
	uint8_t file_data[1]; //!< Pointer to address where file data starts
} __attribute__((packed));
 ...
 *                       requester asked for.
 *  @param[out] data - Pointer to start of file data to be read
 *  @return pldm_completion_codes
 */
 ...
 *  @param[in] length - Number of bytes read. This could be less than what the
 *                      requester asked for.
 *  @param[in] data - File data to be read
 *  @param[in,out] msg - Message will be written to this
 *  @return pldm_completion_codes
 *  @note  Caller is responsible for memory alloc and dealloc of param 'msg'
 */
 ...
 *  @param[out] offset - Offset to the file at which the read should begin
 *  @param[out] length - Number of bytes to be read
 *  @param[out] data - File data to be written
 *  @return pldm_completion_codes
 */
 ...
 *  @param[in] data - File data to be written
 *  @param[in,out] msg - Message will be written to this
 *  @return pldm_completion_codes
 *  @note  Caller is responsible for memory alloc and dealloc of param 'msg'
 */
 ...
 *  @param[in] payload_length - Length of request payload
 *  @param[out] completion_code - PLDM completion code
 *  @param[out] length - Number of bytes to be written
 *  @return pldm_completion_codes
 */
