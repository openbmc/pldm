...
#define PLDM_CONST_READ_FILE_RESP_BYTES                                        \
	5 // read file response bytes without file data size which is variable
#define PLDM_CONST_WRITE_FILE_REQ_BYTES                                        \
	12 // write file request bytes without file data size which is variable
...
/** @brief Decode ReadFileIntoMemory commands request
 *
 *  @param[in] msg - Pointer to PLDM request message payload
 *  @param[in] payload_length - Length of request payload
 *  @param[out] file_handle - A handle to the file
...
/** @brief Create a PLDM response for ReadFile
 *
 *  @param[in] instance_id - Message's instance id
 *  @param[in] command - PLDM command
 *  @param[in] completion_code - PLDM completion code
 ...
 *  @param[out] offset - Offset to the file at which the read should begin
 *  @param[out] length - Number of bytes to be read
 *  @param[out] data - File data to be read
 *  @return pldm_completion_codes
 */
...
/** @brief Create a PLDM response for WriteFile
 *
 *  @param[in] instance_id - Message's instance id
 *  @param[in] command - PLDM command
 *  @param[in] completion_code - PLDM completion code
