...
enum pldm_fileio_commands {
	...
	PLDM_READ_FILE_TYPE = 0xB,
	PLDM_WRITE_FILE_TYPE = 0xC,
};
...
#define PLDM_RW_FILE_TYPE_REQ_BYTES 14
#define PLDM_RW_FILE_TYPE_RESP_BYTES 5
...
/** @struct pldm_read_write_file_type_req
 *
...
/** @struct pldm_read_write_file_type_resp
 *
 *  Structure representing ReadFileByType and
