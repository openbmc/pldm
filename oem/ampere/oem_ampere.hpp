...
class OemAMPERE
{
  ...
  public:
    ...
    explicit OemAMPERE(
        ...
        uint8_t /* mctp_eid */, pldm_pdr* /* repo */,
        pldm::InstanceIdDb& inInstanceIdDb, sdeventplus::Event& inEvent,
        responder::Invoker& /* invoker */, HostPDRHandler* /* hostPDRHandler */,
        ...
        pldm::requester::Handler<pldm::requester::Request>* inReqHandler) :
        instanceIdDb(inInstanceIdDb), event(inEvent),
        platformHandler(platformHandler), reqHandler(inReqHandler)
    {
